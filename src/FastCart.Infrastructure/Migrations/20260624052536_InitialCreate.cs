        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipFirstName = table.Column<string>(type: "text", nullable: false),
                    ShipLastName = table.Column<string>(type: "text", nullable: false),
                    ShipStreetAddress = table.Column<string>(type: "text", nullable: false),
                    ShipApartment = table.Column<string>(type: "text", nullable: true),
                    ShipCity = table.Column<string>(type: "text", nullable: false),
                    ShipPhone = table.Column<string>(type: "text", nullable: false),
                    ShipEmail = table.Column<string>(type: "text", nullable: false),
                    BillFirstName = table.Column<string>(type: "text", nullable: true),
                    BillLastName = table.Column<string>(type: "text", nullable: true),
                    BillStreetAddress = table.Column<string>(type: "text", nullable: true),
                    BillApartment = table.Column<string>(type: "text", nullable: true),
                    BillCity = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductOptionValues_Colors_ColorId",
                        column: x => x.ColorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariantOptionValues_ProductOptionValues_ProductOptio~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOptionValues_ColorId",
